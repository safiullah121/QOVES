  ...
  return (
    ...
    >
      <div className="w-full flex items-center justify-center ">
        <div className="xl:max-w-[52%] xl:h-[79vh]  md:max-w-[80.8%] xsm:max-w-[100%] md:mt-[298px] md:mb-[238px] xl:mt-[0px] xl:mb-[0px]  m-auto  flex flex-col items-center justify-center">
          <h1 className="text-center 3xl:text-[70px] 3xl:leading-[70px] xl:text-[46px] xl:leading-[49px] md:text-[46px] md:leading-[42px] xsm:text-[42px] xsm:tracking-[-1.68px] xsm:leading-[42px] font-[400] 3xl:tracking-[-2.1px] xl:tracking-[-1.38px]  md:tracking-[-1.38px] text-[#FFF] PPNeue md:max-w-[80%] xl:max-w-[100%] xsm:max-w-[376px] w-full ">
            Report has been emailed to alicemendel@gmail.{" "}
            <br className="xsm:flex md:hidden" /> com
          </h1>
