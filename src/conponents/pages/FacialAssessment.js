...
const FacialAssessment = (props) => {
  ...
  return (
    ...
    <div className='flex xl:flex-row md:flex-col-reverse xsm:flex-col xsm:justify-center xsm:items-center md:justify-start md:items-start h-full' >
      <div className='xl:max-w-[49.9%] xsm:max-w-[375px] md:max-w-[100%] xl:h-[41vh] md:h-[43.75%] xsm:h-[51.91%]   w-full xsm:pl-[14px] xsm:pr-[14px] md:pl-[0px] md:pr-[0px]'>
       <div className='3xl:h-[38vh]  xl:h-[43.2vh]    md:w-full md:pt-[31px] xl:pt-[51px] 3xl:pt-[85px] 3xl:pb-[65px] md:pb-[28px] xsm:pb-[36px] xl:pb-[27px] 3xl:pl-[81px] xl:pl-[56px] md:pl-[24px] 3xl:border-b-[1.5px] xsm:border-b-[1px] border-solid border-[#7D828E] border-opacity-[0.15] flex flex-col justify-between'>
       <div className='xsm:pl-[2px] md:pl-[0px] xsm:pb-[36px] xl:pb-[0px] md:pb-[45px]'><h1 className='3xl:text-[80px] md:text-[48px]  3xl:leading-[84px] xsm:text-[44px]  xsm:leading-[42px]  md:leading-[50px] font-[100] italic denton'>Introductory</h1>
       ...
       <div className='3xl:max-w-[510px] xl:max-w-[334px] md:max-w-[546px] xsm:max-w-[300px] w-full 3xl:h-[35px]  flex justify-between 3xl:gap-x-[0px] xl:gap-x-[64px] xsm:gap-x-[64px] xl:gap-y-[17px] 3xl:gap-y-[0px]  md:gap-y-[0px] xsm:gap-y-[26px] 3xl:flex-nowrap xl:flex-wrap md:flex-nowrap xsm:flex-wrap uppercase  PPNeue500'>
        {information.map((i , index)=>(
            <div key={index+ 'information'} className={`${i.classes} flex flex-col 3xl:gap-[5px] xl:gap-[3px] xsm:gap-[4px] 3xl:mt-[0px] `}>
...
<svg className='xsm:flex xl:hidden' xmlns="http://www.w3.org/2000/svg" width="17" height="13" viewBox="0 0 17 13" fill="none">
  ...
  <path d="M15.9993 6.49854H-0.000143528" stroke="white"/>
      ...
      <div className=' xl:bg-FormPhoto md:bg-FormPhoto_4 xsm:bg-FormPhoto_2 bg-cover md:h-[80%] xsm:h-[48.08%] bg-center 3xl:max-w-[50.1%] 3xl:h-[90vh] xsm:max-w-[375px] md:max-w-[100%]  xl:h-[90vh]  xl:pt-0 md:pt-[120px] xsm:pt-[50px] w-full flex xl:items-center md:items-center xsm:pb-[40px] xsm:mt-[26px] md:mt-[0px] xl:pb-[0px]' >
        <div className='3xl:max-w-[48.5%] xl:max-w-[48.23%] md:max-w-[322px] xsm:max-w-[77.3%] 3xl:pt-[18px] md:pt-[15px] xsm:pt-[10px] 3xl:pl-[19px] md:pl-[15px] xsm:pl-[10px] xsm:pb-[12px] xl:pt-[15px] xl:pl-[15px] 3xl:pb-[14px] md:pb-[12px] xl:pb-[13px] mx-auto  w-full xl:h-[47.8%]  md:my-0 xsm:my-auto 3xl:border-[1.5px] xsm:border-[1px] border-solid border-[#FFF] flex flex-col xl:justify-between xl:gap-0 md:gap-[266px] xsm:gap-[246px]'>
          <h1 className='PPNeue 3xl:text-[24px] xl:text-[18px] 3xl:leading-[28px] md:text-[18px] md:leading-[22px] xl:leading-[20px] xsm:text-[20px] xsm:leading-[22px] font-[400] text-[#FFF] 3xl:max-w-[167px] xl:max-w-[167px] xsm:max-w-[167px]  w-full'>Facial Aesthetic Assessments</h1>
