  ...
  return (
    <Layout handleNextClick={props.handleNextClick} handlePrevClick={props.handlePrevClick}>
      <div className="flex md:flex-col-reverse xl:flex-row h-full justify-center items-center">
        <div className="xl:max-w-[49.9%] md:max-w-[100%]   md:h-[36.7%] xl:h-[79vh] w-full flex flex-col justify-between ">
          <div className="xl:h-[34.1%] w-full 3xl:border-b-[1.5px]   xl:border-b-[1.5px]  xsm:border-b-[1px] md:border-b-[0px]  border-solid border-[#7D828E] border-opacity-[0.15]">
            <div className="3xl:pt-[99px] md:pt-[30px] xl:pt-[59px] xsm:pt-[46px] xsm:pl-[14px] xsm:pb-[22px] md:pb-[48px] 3xl:pl-[74px] md:pl-[24px] xl:pl-[50px] flex items-end md:gap-[10px] xsm:gap-[3px]">
        ...
        <div className="xsm:hidden md:flex xl:max-w-[50.1%]  md:h-[63.3%] md:max-w-[100%] md:pb-[29px] md:pt-[21px] xl:h-[79vh] w-full flex items-center justify-center xl:border-l-[1.5px] md:border-b-[1px] xl:border-b-0 border-solid border-[#7D828E] border-opacity-[0.15] ">
